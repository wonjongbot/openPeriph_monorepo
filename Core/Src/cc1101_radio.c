...
#define CC1101_WRITE_SETTING_OR_RETURN(addr, value) \
    do { \
        if (!Cc1101_WriteReg((addr), (value))) { \
            return false; \
        } \
    } while (0)

static bool Cc1101_WriteSettings(void)
{
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_IOCFG2, 0x29U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_IOCFG1, 0x2EU);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_IOCFG0, 0x06U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FIFOTHR, 0x47U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_SYNC1, 0xD3U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_SYNC0, 0x91U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_PKTLEN, 0xFFU);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_PKTCTRL1, 0x04U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_PKTCTRL0, 0x05U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_ADDR, OPENPERIPH_NODE_ADDR);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_CHANNR, OPENPERIPH_RF_CHANNEL_DEFAULT);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FSCTRL1, 0x08U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FSCTRL0, 0x00U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FREQ2, 0x10U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FREQ1, 0xB4U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FREQ0, 0x2EU);
    ...
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_MDMCFG1, 0x22U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_MDMCFG0, 0xF8U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_DEVIATN, 0x34U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_MCSM2, 0x07U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_MCSM1, 0x30U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_MCSM0, 0x18U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FOCCFG, 0x16U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_BSCFG, 0x6CU);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_AGCCTRL2, 0x43U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_AGCCTRL1, 0x40U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_AGCCTRL0, 0x91U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_WOREVT1, 0x87U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_WOREVT0, 0x6BU);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_WORCTRL, 0xF8U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FREND1, 0x56U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FREND0, 0x10U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FSCAL3, 0xE9U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FSCAL2, 0x2AU);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FSCAL1, 0x00U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FSCAL0, 0x1FU);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_RCCTRL1, 0x41U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_RCCTRL0, 0x00U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_FSTEST, 0x59U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_PTEST, 0x7FU);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_AGCTEST, 0x3FU);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_TEST2, 0x81U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_TEST1, 0x35U);
    CC1101_WRITE_SETTING_OR_RETURN(CC1101_REG_TEST0, 0x09U);

    return true;
}

#undef CC1101_WRITE_SETTING_OR_RETURN
